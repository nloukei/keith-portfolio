                ...
                >
                  ...
                  <div className="absolute top-4 right-4">
                    <motion.button
                      ...
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.98 }}
                      className="rounded-full bg-zinc-900/92 backdrop-blur-md px-4 py-2 border border-white/20 text-white font-mono text-[11px] tracking-[0.15em] shadow-[0_4px_24px_rgba(0,0,0,0.45)] hover:border-[#D71921]/55 hover:bg-zinc-900 transition-colors duration-200"
                    >
                      Close ✕
                    </motion.button>
                  </div>
                  ...
                  <div className="absolute left-4 right-4 bottom-4 flex justify-between pointer-events-none">
                    <motion.button
                      ...
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.98 }}
                      className="pointer-events-auto rounded-full bg-zinc-900/92 backdrop-blur-md px-4 py-2 border border-white/20 text-white font-mono text-[11px] tracking-[0.15em] shadow-[0_4px_24px_rgba(0,0,0,0.45)] hover:border-[#D71921]/55 hover:bg-zinc-900 transition-colors duration-200"
                    >
                      ← Prev
                    </motion.button>
                    <motion.button
